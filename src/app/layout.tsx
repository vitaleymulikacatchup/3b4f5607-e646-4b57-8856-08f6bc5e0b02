...
export const metadata: Metadata = {
  ...
  description: "Experience unparalleled luxury at Grand Vista Hotel. Award-winning service, elegant rooms, world-class amenities, and prime location in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, spa, fine dining, business travel, vacation, hospitality",
  openGraph: {
    title: "Grand Vista Hotel - Luxury 5-Star Accommodation",
    description: "Experience unparalleled luxury at Grand Vista Hotel with award-winning service and world-class amenities.",
